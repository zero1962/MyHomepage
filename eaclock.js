...
jikan=2;
document.write("<DIV STYLE='position:absolute;font-size:"+ensize+";top:"+(centery*1.02-ensize/2)+";left:"+(centerx*1.0-ensize/2)+";color:"+encolor+"'>●</DIV>");
for(i=0;i<12;i++)
{
...
document.write("<DIV STYLE='position:absolute;font-size:"+tensize+";top:"+(centery*1.02-tensize/2)+";left:"+(centerx*1.0-tensize/2)+";color:"+tencolor+"'>●</DIV>");
function Nowtime()
{
	Now=new Date();
	S=Now.getSeconds()-15;
